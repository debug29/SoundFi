...
- (void)viewDidLoad
{
    ...
    if (!firstLaunch) {
        ...
        messageList = [defaults objectForKey:@"messageList"];
        if (messageList==nil) {
...
-(void)initUI
{
    ...
    if (IS_IPHONE_5)
        ...
        messageTableView=[[UITableView alloc]initWithFrame:CGRectMake(0,65, 320,415) style:UITableViewStylePlain];
    messageTableView.dataSource = self;
    messageTableView.delegate=self;
    messageTableView.editing=FALSE;
    messageTableView.alpha=0.;
    messageTableView.backgroundColor=[UIColor clearColor];
    messageTableView.layer.borderWidth=1.0f;
    messageTableView.layer.borderColor= [firstColor CGColor];
...
-(void)seeMyNotif
{
    ...
    messageTableView.allowsSelection=YES;
    messageTableView.allowsSelectionDuringEditing=YES;
...
-(void)messageReceived:(NSString*)theMessage :(int)quality
{
    ...
    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
    [defaults setObject:messageList forKey:@"messageList"];
...
- (void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.textColor=firstColor;
    cell.textLabel.font=myFont;
