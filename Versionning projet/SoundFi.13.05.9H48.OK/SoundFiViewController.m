...
-(void)initUI
{
    ...
    msgTextView.layer.borderColor = [[UIColor whiteColor] CGColor];
    ...
    returnMenu.layer.borderColor= [[UIColor whiteColor] CGColor];
    [returnMenu setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    ...
    backMenu.layer.borderColor= [[UIColor whiteColor] CGColor];
    [backMenu setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
...
-(void)sendMessage
{
    ...
    //messageToSend=@"{type : 1 image_uti : \"http://soudfi.com/images/67531686.jpg\", text : \"Bonjour, bienvenue sur SoundFi. Ceci est un message de test pour une taille standard en nombre de caracteres. L'objectif est que ce message passe sans erreurs et avec tous les caracteres.\"}";
    //NSLog(@"\nLongueur : %lu\n",(unsigned long)[messageToSend length]);
    //NSLog(@"Envoie du message : %@",messageToSend);
...
{
    soundFiSession=[[SoundFiAudioSession alloc]init];
