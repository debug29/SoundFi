  /**
    ...
    * Ce script permet l'envoie d'un message envoyer par ultrason sur une plage 
  ...
  */
  ...
  function errorStream(){
    ...
    /**
      * @function
      * @name sendMessage
      * @description Cette fonction sert d'intermédiaire entre l'UI et la techno, elle récupère depuis la page html le message à envoyer
    */
  function sendMessage(){
    var message = "Note:" + removeDiacritics(document.getElementById('inputText').value);
    if (message!=null)
    ...
    /**
      * @function
      * @name frequencyLoad
      * @param {String} message Le message à envoyer (sans accents ^^) 
      * @description Cette fonction va convertir chaque caractère en fréquence et définir le moment auquel il doit être envoyer, elle est actuelelment calibrée 
        pour fonctionner avec l'iPhone sur un envoie cadencé à 512/44100 sec
    */
  function frequencyLoad(message){
    ...
    /**
      * @function
      * @name sendTone
      * @description Envoie une fréquence toute les 512/44100 sec
      * @param {Number*} freq La liste de fréquence à envoyer 
      * @param {Number} startTime La date de bépart de l'envoie
      * @param {duration} La date de fin de l'envoie 
    */
  ...
  navigator.getUserMedia( {audio:true}, gotStream,errorStream);
    ...
    /**
      ...
      * @description Retire tous les caractères spéciaux d'une chaine de caractère
      * @param {String} str La date de bépart de l'envoie
      * @param {duration} La date de fin de l'envoie 
    */
