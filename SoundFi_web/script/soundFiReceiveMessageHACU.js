  ...
  */
  ...
  function update(){
    ...
    if(hightaccuFreq>17500){
      ...
      if (hightaccuFreq>17750 && hightaccuFreq<17850 && !messageStart) {
        messageInReception = "";
        messageStart = true;
        callbackPeriod=40;
      ...
      else if(hightaccuFreq>19720 && hightaccuFreq<19739 && messageStart){
        messageStart = false;
        console.log("Stop");
        ...
        if (DEBUG)
          console.log(hightaccuFreq);
        if (hightaccuFreq>19467 && hightaccuFreq<19488){
          messageInReception= messageInReception + "r";
        }
        else if (hightaccuFreq>18791 && hightaccuFreq<18803){
          messageInReception= messageInReception + "L";
        }
        else if (hightaccuFreq>18803 && hightaccuFreq<18821){
          messageInReception= messageInReception + "M";
        }
        else if (hightaccuFreq>18441 && hightaccuFreq<18461){
          messageInReception= messageInReception + "9";
        }
        else {
          messageInReception= messageInReception + String.fromCharCode(32 + Math.round(((hightaccuFreq-18000)/18)))
        }
      }
