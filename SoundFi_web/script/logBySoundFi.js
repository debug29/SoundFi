  ...
  function analysis(message_){
    ...
    splitTab = finalMessage.split('&');
    var email = splitTab[0];
    var pwd = splitTab [1];
  ...
  function logCheck(SFemail,SFpwd){
    if(SFemail == null && SFpwd == null){
      var email = document.getElementById("mail").value;
      var pwd = document.getElementById("pwd").value;
      console.log(email);
      console.log(pwd);

      if (email == "soundfi@gmail.com" && pwd == "123soleil")
        location.href = "http://rickrolled.fr/";
    }
    else{
      if (SFemail == "soundfi@gmail.com" && SFpwd == "123soleil")
        location.href = "http://rickrolled.fr/";
    }
  }
