  ...
  */
  ...
  function sendMessage(){
    ...
    /**
      * @function
      * @name frequencyLoad
      * @param  message Le message à envoyer (sans accents ^^) 
  ...
  function frequencyLoad(message){
    ...
    /**
      ...
      * @param  freq La liste de fréquence à envoyer 
      * @param  startTime La date de bépart de l'envoie
      * @param  La date de fin de l'envoie 
    */
  ...
  navigator.getUserMedia( {audio:true}, gotStream,errorStream);
    ...
    /**
      ...
      * @param  str La date de bépart de l'envoie
      * @param  La date de fin de l'envoie 
    */
