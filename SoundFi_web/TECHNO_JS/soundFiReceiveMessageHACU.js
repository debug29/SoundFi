  ...
  */
  ...
  navigator.getUserMedia( {audio:true}, gotStream,errorStream);
    ...
    /**
      ...
      * @param  fftFrameSize La taille de l'échantillon (multiple de 2)
      * @param  sampleRate Le ratio audio (44100Hz) 
      * @param  algo Le type d'algo utilisé ici, mettre FFT
      * @see {@link getReady}
    */
...
Pitchshift.prototype.getready = function (fftFrameSize, sampleRate, algo) {
    ...
    /**
      ...
      * @param  Une instance de pitchShift préalablement init
      * @param  numSampToProcess Le nombre de valeur dans un échantillon
      * @param  osamp OverSample value, je conseil d'utilisé 8, cela augmente la précision au maximum mais utilise plus de ressource.
      * @param  inData Un pointeur vers le tableau de l'échantillon
      * @return  frequency La fréquence dominante déduite de l'échantillon
      * @see {@link getReady}
    */
