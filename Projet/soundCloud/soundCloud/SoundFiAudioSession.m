...
-(SoundFiAudioSession*)init
{
    ...
    monoFrequencyReceptionMode=FALSE;
    
    nbrEchantillon=512; //512
...
-(int)initAudioSession
{
    ...
    [mySession setPreferredIOBufferDuration: ((float)nbrEchantillon/sampleRate) error: &audioSessionError]; //Number of sample must depend of the mode WALE 512
    // and so the fft size in the code 512 -> 512 everywhere
